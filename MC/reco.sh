...
o2-its-reco-workflow --trackerCA --tracking-mode async --configKeyValues 'ITSVertexerParam.phiCut=0.5; ITSVertexerParam.clusterContributorsCut=3; ITSVertexerParam.tanLambdaCut=0.2' -b --shm-segment-size 10000000000
o2-tpc-reco-workflow --shm-segment-size 30000000000 --input-type digits --output-type clusters,tracks,send-clusters-per-sector  --configKeyValues "HBFUtils.orbitFirstSampled=0;HBFUtils.nHBFPerTF=256;GPU_global.continuousMaxTimeBin=100000;GPU_proc.ompThreads=4;GPU_rec.maxTrackQPt=20.0" -b
